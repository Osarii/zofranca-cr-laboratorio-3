    ...
    <svg className={className} viewBox="0 0 48 48" role="img" aria-label="Isotipo de ZoFranca CR">
      <defs>
        <linearGradient id={gradienteId} x1="6" y1="5" x2="42" y2="43" gradientUnits="userSpaceOnUse">
          <stop stopColor="#C98A78" />
          <stop offset="0.52" stopColor="#9A4D5D" />
          <stop offset="1" stopColor="#B88958" />
        </linearGradient>
      </defs>
      ...
      <path d="M29.5 25.5 36 20v8.8L29.5 34v-8.5Z" fill="#F4E6D4" opacity="0.95" />
      <circle cx="37" cy="11" r="3" fill="#D8BE9D" />
