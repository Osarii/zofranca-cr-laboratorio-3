    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-5 py-2.5 bg-[#0B2B4A] hover:bg-[#153e6b] active:bg-[#071d33] text-white text-xs font-bold rounded-xl shadow-xs hover:shadow-md transition-all duration-150 flex items-center gap-2 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm card-hover-effect space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <h3 className="font-bold text-sm text-[#0B2B4A]">Cumplimiento de Inversión</h3>
                <p className="text-xs text-[#4A5568]">Compromiso Contractual vs Activos Fijos</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm card-hover-effect space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              <div className="w-9 h-9 rounded-xl bg-sky-50 text-[#2D9CDB] flex items-center justify-center font-bold">
                <Users className="w-5 h-5" />
              </div>
              <div>
                <h3 className="font-bold text-sm text-[#0B2B4A]">Cumplimiento de Empleo</h3>
                <p className="text-xs text-[#4A5568]">Planillas CCSS vs Metas Acordadas</p>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-slate-100 rounded-full h-3 overflow-hidden">
              <div className="bg-[#2D9CDB] h-3 rounded-full transition-all duration-700" style={{ width: '91%' }}></div>
            </div>
          </div>
        </div>
      </div>
                ...
                return (
                  <tr key={emp.id} className="hover:bg-sky-50/40 transition-colors duration-150">
                    <td className="py-3.5 px-4">
                      <div className="flex items-center space-x-2.5">
                        <div className="w-8 h-8 rounded-lg bg-sky-50 flex items-center justify-center text-[#2D9CDB] font-bold">
                          <Building2 className="w-4 h-4" />
                        </div>
                        <div>
                          <div className="font-bold text-[#0B2B4A]">{emp.name}</div>
                          <div className="text-[11px] font-mono text-[#4A5568]">{emp.code}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-3.5 px-4">
                      ...
                      <div className="text-[11px] text-[#4A5568] flex items-center gap-1">
                    ...
                    <td className="py-3.5 px-4">
                      ...
                      <div className="text-[11px] text-[#4A5568]">Reportadas a CCSS</div>
                    </td>
